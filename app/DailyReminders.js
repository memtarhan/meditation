...
const DailyReminders = () => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: isDarkTheme ? COLORS.darkBackground : COLORS.lightWhite }}>
            {/* App Bar */}
            <ScreenHeaderBtn isAppBar={true} title="Daily Reminders" />
            ...
            <ScrollView contentContainerStyle={{ padding: SIZES.medium }}>
                <Calendar
                    ...
                    theme={{
                        calendarBackground: isDarkTheme ? COLORS.dark : COLORS.lightWhite,
                        textSectionTitleColor: isDarkTheme ? COLORS.lightWhite : COLORS.primary,
                        dayTextColor: isDarkTheme ? COLORS.lightWhite : COLORS.primary,
                        todayTextColor: COLORS.primary,
                        selectedDayBackgroundColor: COLORS.primary,
                        selectedDayTextColor: COLORS.lightWhite,
                        monthTextColor: isDarkTheme ? COLORS.lightWhite : COLORS.primary,
